...
public class SonarqubeSchema {
	...
	public static Schema sonarmeasure = SchemaBuilder.struct().name("sonarmeasure")
			...
			.field(FIELD_SONAR_SNAPSHOT_DATE, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_BASECOMPONENT_ID, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_BASECOMPONENT_KEY, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_BASECOMPONENT_NAME, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_BASECOMPONENT_QUALIFIER, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_COMPONENT_ID, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_COMPONENT_KEY, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_COMPONENT_NAME, Schema.STRING_SCHEMA)
			.field(FIELD_SONAR_MEASURE_COMPONENT_QUALIFIER, Schema.STRING_SCHEMA)
