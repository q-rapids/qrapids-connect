...
public class TaigaSourceConfig extends AbstractConfig {
    ...
    public static final String TAIGA_TEAMS_INTERVAL_CONFIG = "taiga.teams.interval.seconds";
    public static final String TAIGA_TEAMS_INTERVAL_CONFIG_DISPLAY = "Time interval between polling of different teams in seconds";
    public static final String TAIGA_TEAMS_INTERVAL_CONFIG_DOC = "Time interval between polling of different teams in seconds";
    public static final int TAIGA_TEAMS_INTERVAL_CONFIG_DEFAULT = 120;
    ...
    static {
        DEFS
            ...
            .define(TAIGA_TEAMS_INTERVAL_CONFIG, ConfigDef.Type.LONG, TAIGA_TEAMS_INTERVAL_CONFIG_DEFAULT, ConfigDef.Importance.LOW, TAIGA_TEAMS_INTERVAL_CONFIG_DOC, TAIGA_GROUP, 9, ConfigDef.Width.SHORT,  TAIGA_TEAMS_INTERVAL_CONFIG_DISPLAY)
            .define(TAIGA_EPIC_TOPIC_CONFIG, ConfigDef.Type.STRING, TAIGA_EPIC_TOPIC_CONFIG_DEFAULT, ConfigDef.Importance.LOW, TAIGA_EPIC_TOPIC_CONFIG_DOC, TAIGA_GROUP, 10, ConfigDef.Width.MEDIUM, TAIGA_EPIC_TOPIC_CONFIG_DISPLAY)
            .define(TAIGA_USERSTORY_TOPIC_CONFIG, ConfigDef.Type.STRING, TAIGA_USERSTORY_TOPIC_CONFIG_DEFAULT, ConfigDef.Importance.LOW, TAIGA_USERSTORY_TOPIC_CONFIG_DOC, TAIGA_GROUP, 11, ConfigDef.Width.MEDIUM, TAIGA_USERSTORY_TOPIC_CONFIG_DISPLAY)
            .define(TAIGA_TASK_TOPIC_CONFIG, ConfigDef.Type.STRING, TAIGA_TASK_TOPIC_CONFIG_DEFAULT, ConfigDef.Importance.LOW, TAIGA_TASK_TOPIC_CONFIG_DOC, TAIGA_GROUP, 12, ConfigDef.Width.MEDIUM, TAIGA_TASK_TOPIC_CONFIG_DISPLAY)
            .define(TAIGA_TASK_CUSTOM_ATTRIBUTES_CONFIG, ConfigDef.Type.STRING, "", ConfigDef.Importance.LOW, TAIGA_TASK_CUSTOM_ATTRIBUTES_CONFIG_DOC, TAIGA_GROUP, 13, ConfigDef.Width.MEDIUM, TAIGA_TASK_CUSTOM_ATTRIBUTES_CONFIG_DISPLAY)
            .define(TAIGA_USERSTORY_CUSTOM_ATTRIBUTES_CONFIG, ConfigDef.Type.STRING, "", ConfigDef.Importance.LOW, TAIGA_USERSTORY_CUSTOM_ATTRIBUTES_CONFIG_DOC, TAIGA_GROUP, 14, ConfigDef.Width.MEDIUM, TAIGA_USERSTORY_CUSTOM_ATTRIBUTES_CONFIG_DISPLAY);
    }
