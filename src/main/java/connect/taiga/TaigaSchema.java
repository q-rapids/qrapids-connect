...
import model.taiga.AssignedToExtraInfo;
import model.taiga.Epic;
import model.taiga.StatusExtraInfo;
import model.taiga.UserStoriesCounts;
...
public class TaigaSchema {
    ...
    public static Schema taigaMilestone = SchemaBuilder.struct().name("taigamilestone")
            ...
            .field(FIELD_TAIGA_MILESTONE_CLOSED_POINTS ,Schema.OPTIONAL_INT32_SCHEMA)
            .field(FIELD_TAIGA_MILESTONE_TOTAL_POINTS ,Schema.OPTIONAL_INT32_SCHEMA)
    ...
    public static Schema taigaUserStory = SchemaBuilder.struct().name("taigauserstory")
            ...
            .field("modified_date" ,Schema.OPTIONAL_STRING_SCHEMA )
            .field("finished_date" ,Schema.OPTIONAL_STRING_SCHEMA )
            .field("total_points" ,Schema.OPTIONAL_INT32_SCHEMA )
            ...
            .field("milestone_closed_points" ,Schema.OPTIONAL_INT32_SCHEMA)
            .field("milestone_total_points" ,Schema.OPTIONAL_INT32_SCHEMA)
